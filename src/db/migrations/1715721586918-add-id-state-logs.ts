...
export class AddIdStateLogs1715721586918 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "stateLogs" ADD CONSTRAINT "PK_84d63b2dc22df0a091bd6a6b634" PRIMARY KEY ("id")`);
        ...
        await queryRunner.query(`ALTER TABLE "stateLogs" ADD CONSTRAINT "FK_2c90f0cfa3678b37bf927ae193b" FOREIGN KEY ("vehicleId") REFERENCES "vehicles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
